...
public class CouponPercent implements Coupon {
    String couponID;
    UUID sellerID;
    CouponType type;
    int promote;
    ...
    public CouponPercent(String couponID, UUID sellerID, int promote, int minConditionMoney, int maxPromoteMoney, long dayDuration) {
    ...
    public CouponPercent(String couponID, UUID sellerID, CouponType type, int promote, int minConditionMoney, int maxPromoteMoney, LocalDateTime startTime, long dayDuration, LocalDateTime endTime) {
        this.couponID = couponID;
        this.sellerID = sellerID;
        this.type = type;
        this.promote = promote;
